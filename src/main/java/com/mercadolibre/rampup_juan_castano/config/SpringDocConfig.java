...
import static com.mercadolibre.rampup_juan_castano.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.rampup_juan_castano.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("jucastano")
                .email("juan.castano@mercadolibre.com.co"));
